<template>
    <div class="profile-cards-container flex">
        <div class="left-container">
            <profileCard :image="require('@/assets/logo.png')" :cardImage1="require('@/assets/icons/carte_jeune.svg')" :cardImage2="require('@/assets/icons/abo_fréquence.svg')" cardImageText1="carte jeune" cardImageText2="Abo.fréquence" title="Jeune" definition="18- 25 ans" :numberbottom=10 :numberleft=10 :numberright=20>
            </profileCard>
            <profileCard :image="require('@/assets/logo.png')" cardImage1="empty" :cardImage2="require('@/assets/icons/abo_fréquence.svg')" cardImageText2="Abo.fréquence" title="PRO" definition="2 A/R par mois" :numberbottom=10 :numberleft=10 :numberright=20>
            </profileCard>
        </div>
